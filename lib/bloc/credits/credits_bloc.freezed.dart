...
mixin _$CreditsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Credit> credit) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Credit> credit)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Credit> credit) : _credit = credit;

  final List<Credit> _credit;
  @override
  List<Credit> get credit {
    if (_credit is EqualUnmodifiableListView) return _credit;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_credit);
  }

  @override
  String toString() {
    return 'CreditsState.loaded(credit: $credit)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_credit));
...
abstract class _Loaded implements CreditsState {
  const factory _Loaded(final List<Credit> credit) = _$LoadedImpl;
