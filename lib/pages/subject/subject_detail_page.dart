...
import 'widgets/subject_detail_tile.dart';
...
class SubjectAttendancePage extends StatefulWidget {
  ...
  @override
  State<SubjectAttendancePage> createState() => _SubjectAttendanceState();
}

class _SubjectAttendanceState extends State<SubjectAttendancePage> {
  @override
  void initState() {
    super.initState();
